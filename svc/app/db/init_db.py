...
from app.models.audit_task import AuditFlow, AuditFlowData, AuditTask
...
async def init_db():
    await init_beanie(
        ...
        document_models=[User, LabelTask, Data, Team, TeamInvitationLink, Record, AuditTask, AuditFlow, AuditFlowData, File],  # type: ignore
    )
