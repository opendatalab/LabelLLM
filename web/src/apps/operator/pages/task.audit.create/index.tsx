...
export default function CreateTask() {
  ...
  const [, setBasicCache] = useSessionStorage('audit_task_basic_cache');
  const [, setToolCache] = useSessionStorage('audit_task_tool_cache');

  const taskInfo = useRouteLoaderData('auditTask') as OperatorTaskDetail;
